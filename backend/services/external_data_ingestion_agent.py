...
class ExternalIngestionProcessor:
    ...
    def _generate_embedding_sync(self, text: str) -> str:
        ...
        vector (logged) if the embedding service is unavailable.
        """
        # ponytail: duplicated from ingestion_agent.py; dedupe both into one shared
        # embedding helper in Phase 5 (both files are wholesale duplicates today).
